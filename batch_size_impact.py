...
def run(out_data_path: Path, batch_transform, dataloader_train: DataLoader, model: GAN, batch_size: int):
...
if __name__ == "__main__":
    ...
    sample_transform = Compose([
        ...
        transformation.RandomPerspective(yaw=(0, 360), pitch=(-40, 60), w_fov=(60, 120)),
    ...
    for batch_size in [1, 1, 2, 4, 8, 12, 16, 20, 24]:
        dataloader_train = DataLoader(dataset_train, batch_size=batch_size, shuffle=False, num_workers=4, pin_memory=True)
        model = GAN(
